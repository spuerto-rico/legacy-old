...
class SCHealthGoal extends Component {
  ...
  componentDidMount() {
    this.props.getBusinessGoal('health');
    this.props.getNextStepGoal('health');
    this.props.getWeeklyActions('health');
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(SCHealthGoal);
